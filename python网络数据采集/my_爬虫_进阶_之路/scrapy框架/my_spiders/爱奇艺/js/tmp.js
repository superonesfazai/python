...
function cmd5xtmts() {
    var a = {};
    return a.qd_v = 1,
    a.qdy = "function%20javaEnabled%28%29%20%7B%20%5Bnative%20code%5D%20%7D" === escape(navigator.javaEnabled.toString()) ? "a" : "i",
    a.qds = 0,
    "undefined" != typeof js_call_java_obj && (a.qds = 1),
    a.tm = Date.parse(new Date()) / 1000,
    a
}
function cmd5xdash() {
    var a = cmd5xtmts();
    return a.tm = new Date().getTime(),
    a
}
function cmd5xlive() {
    return cmd5xtmts()
...
// 下面是加密函数
function E(e, t, i, o) {
    var n = window.cmd5xtmts ? window.cmd5xtmts() : {};
    o && n.tm && (n.tm = o),
    $.extend(i || {}, n, {
        src: "02020031010000000000"
    });
    var a = "/jp/tmts/" + e + "/" + t + "/?" + $.param(i) + "&callback=tmtsCallback";
    return i.vf = window.cmd5x ? window.cmd5x(a) : "",
    i
}