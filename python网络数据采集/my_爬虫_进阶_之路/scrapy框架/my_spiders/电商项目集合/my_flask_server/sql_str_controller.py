...
tb_select_str_3 = '''
select top 1500 SiteID, GoodsID, IsDelete, Price, TaoBaoPrice, shelf_time, delete_time, SKUInfo, IsPriceChange, is_spec_change, PriceChangeInfo, is_stock_change, stock_change_info, sku_info_trans_time, spec_trans_time, stock_trans_time, ModfiyTime 
from dbo.GoodsInfoAutoGet 
where SiteID=1 
and MainGoodsID is not null
