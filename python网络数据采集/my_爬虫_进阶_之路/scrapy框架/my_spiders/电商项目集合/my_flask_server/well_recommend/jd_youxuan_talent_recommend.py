            ...
            if body != []:
                ...
                if data.get('user_list') is None:   # 表示没有数据了，返回的为 square({"errmsg":"","iRet":0,"totalnum":347} )
                    ...
                    for item in user_list:
                        ...
                        sql_str = 'select SiteID, GoodsID, IsDelete, MyShelfAndDownTime, Price, TaoBaoPrice from dbo.GoodsInfoAutoGet where SiteID=7 or SiteID=8 or SiteID=9 or SiteID=10'
