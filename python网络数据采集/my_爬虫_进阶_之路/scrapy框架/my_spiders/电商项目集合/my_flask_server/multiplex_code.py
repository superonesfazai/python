...
ARTICLE_TITLE_SENSITIVE_STR_TUPLE = (
    ...
    '共产党', '色情', '法轮功', '女优', '共狗', '天猫', '淘宝', '拼多多', '京东', '折800',
    '小区介绍', '今日头条', '广告', '公示', '干部', '旧改',
    # 地区
    '社区', '县', '村', '镇',
    # 散文, 诗词等
    '散文', '诗词{0}', '文言文', '[对上下]联', '考试', '[高中]考', '申请\w+大学', '学习口诀', '[数物化竞英]{1}[学理赛语]{1}题',
    '学习要点',
    # 非准时间点
    '[今昨明后前]{1}[晚天夜]{1}',
    # 过期的节日
    ...
    '思域',
    # 互联网
    '互联网', '站外引流', '编程', '代码', 'coder{0}', '网警', '程序[员猿媛]{1}', 'python', 'java', 'js', 'swift', 'go',
    ...
    '全双工通信', 'proxy', '架构师', '死锁', '产品经理', 'UI设计', '码农', '软件测试',
    # 楼
    '楼市',
    # 游戏
