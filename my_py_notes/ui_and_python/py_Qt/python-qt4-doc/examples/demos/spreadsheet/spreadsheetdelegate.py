...
class SpreadSheetDelegate(QtGui.QItemDelegate):
    ...
    def createEditor(self, parent, styleOption, index):
        ...
        autoComplete = QtGui.QCompleter(allStrings)
    ...
    def setEditorData(self, editor, index):
        if isinstance(editor, QtGui.QLineEdit):
            ...
            editor.setDate(QtCore.QDate.fromString(
                index.model().data(index, QtCore.Qt.EditRole), self.parent().currentDateFormat))
