...
class SpreadSheetItem(QtGui.QTableWidgetItem):
    ...
    def formula(self):
        return super(SpreadSheetItem, self).data(QtCore.Qt.DisplayRole)

    def data(self, role):
        if role in (QtCore.Qt.EditRole, QtCore.Qt.StatusTipRole):
            return self.formula()
