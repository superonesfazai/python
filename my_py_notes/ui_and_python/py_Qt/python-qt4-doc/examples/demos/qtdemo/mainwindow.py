...
class MainWindow(QtGui.QGraphicsView):
    ...
    def setupWidget(self):
        ...
        self.setWindowTitle("py_Qt Examples and Demos")
    ...
    def quit(self):
        # This is a bit of a hack to avoid calling QCoreApplication.quit()
        # which causes a number of error messages from
        # QGLContext::makeCurrent() to be generated (on x11 and starting with
        # Qt v4.7) when the interpreter is closing down.
        import sys
        sys.exit()
